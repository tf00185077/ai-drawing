...
This is a Unicode **text-stream** API, not an arbitrary binary-stream API. A
script that must move byte-exact binary data should encode it as text (for
example, Base64) and decode it at its destination.

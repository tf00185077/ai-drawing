...
_SAFE_MESSAGES = {
    ...
    "COMFYUI_START_TIMEOUT": "ComfyUI did not become ready before the health deadline",
    "WORKER_START_TIMEOUT": "the Worker did not become ready before the health deadline",
    "WORKER_STATUS_INVALID": "the Worker status or source commit was invalid",
    "WORKER_PREFLIGHT_FAILED": "the Worker required-node preflight did not pass",

...
W,H=832,1216
POSE='2026-06-30/louise_pose_skeleton_4step_01_01_down.png'
STYLE_PROMPT=(
...
"academy uniform, white blouse, black capelet, pleated skirt, matching knee-high socks, shoes, full body, complete head-to-toe visible, "
"three-quarter side view, character placed in the lower left corner, character occupies only two cells of a 3x3 grid, small figure in left-middle and left-bottom grid cells, "
...
"cartoon style European castle background, complete European castle visible across the full image, pointed spire towers, stone walls, rooftops, arched windows, full scene composition"
)
STYLE_SUFFIX=(
...
"photorealistic, oil painting, thick impasto, dark gothic palette, hard cel shading, dense detailed background, close-up, upper body, cropped body, cropped feet, character centered, character too large, "
"front view, back view, raised arm, spell casting, explosion, magic effect, night sky, incomplete castle, cropped castle, modern building, mismatched socks, bare legs, ornate wand, curved wand, thick wand, branch wand, forked wand, gem wand, glowing wand, staff, sword, second wand, extra arms, extra hands, bad hands, duplicate character, multiple people"
)
...
jobs=[]
for i,seed in enumerate([27063301,27063302,27063303],1):
    prefix=f'louise_frame01_down_stylepreset_castle_cand{i:02d}'

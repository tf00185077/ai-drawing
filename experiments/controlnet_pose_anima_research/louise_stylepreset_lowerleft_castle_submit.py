...
W,H=832,1216
POSE='2026-06-30/louise_lower_left_both_hands_down_short_wood_wand_pose_ref.png'
STYLE_PROMPT=(
...
"academy uniform, white blouse, black capelet, pleated skirt, matching knee-high socks, full body, complete head-to-toe visible, zoomed out long shot, "
"character placed in the lower left corner of the image, both arms lowered naturally, one lowered hand holds a short straight wood-colored wand with a plain grip handle, "
"plain wooden wand, no branches, no forked tips, no decoration, the other lowered hand empty, "
"cartoon style European castle background, complete castle visible across the whole frame, pointed spire towers, stone walls, rooftops, arched windows, full scene composition"
)
STYLE_SUFFIX=(
"soft backlight, pastel cyan pink blue yellow palette, watercolor wash background, paint splatter particles, floating petals, luminous airy negative space, "
...
"oil painting, thick impasto, dark gothic palette, hard cel shading, dense detailed background, close-up, upper body, cropped body, cropped feet, character centered, character too large, "
"raised arm, spell casting, explosion, magic effect, mismatched socks, bare legs, ornate wand, curved wand, thick wand, branch wand, forked wand, gem wand, glowing wand, staff, sword, second wand, extra arms, extra hands, bad hands, duplicate character, multiple people, incomplete castle, cropped castle, modern building"
)
...
def workflow(prefix,prompt,negative,seed):
    return {
      ...
      "15":{"class_type":"AnimaLLLiteApply","inputs":{"model":["10",0],"lllite_name":"anima-lllite-pose-1.safetensors","image":["14",0],"strength":1.6,"start_percent":0.0,"end_percent":1.0,"preserve_wrapper":True}},
...
jobs=[]
for i,seed in enumerate([27062801,27062802,27062803],1):
    prefix=f'louise_stylepreset_lowerleft_castle_cand{i:02d}'
    payload={'workflow':workflow(prefix,POS,NEG,seed),'prompt':POS,'negative_prompt':NEG,'seed':seed,'steps':28,'cfg':5.1,'width':W,'height':H,'sampler_name':'er_sde','scheduler':'simple','lora':'posing-dynamics-anima.safetensors','lora_strength':0.65,'diffusion_model':'anima_preview3Base.safetensors','text_encoder':'qwen_3_06b_base.safetensors','vae':'qwen_image_vae.safetensors','image_pose':POSE}

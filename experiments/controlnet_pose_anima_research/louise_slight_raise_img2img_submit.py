...
POSE='2026-06-30/louise_lowerleft_wand_hand_slightly_raised_pose_ref.png'
STYLE_PROMPT=(
...
"one hand remains lowered and empty, the wand hand is only slightly raised from the lowered position, holding a short straight wood-colored wand with a plain grip handle, no branches, no forked tips, no decoration, "
"no spell effect, no explosion, complete castle visible across the whole frame"
)
STYLE_SUFFIX=(
"soft backlight, pastel cyan pink blue yellow palette, watercolor wash background, paint splatter particles, floating petals, luminous airy negative space, silhouette-friendly lighting"
)
...
"oil painting, thick impasto, dark gothic palette, hard cel shading, dense detailed background, changed background, different castle, missing castle, cropped castle, modern building, character centered, character too large, "
"raised arm high, spell casting, explosion, magic effect, ornate wand, curved wand, thick wand, branch wand, forked wand, gem wand, glowing wand, staff, sword, second wand, extra arms, extra hands, bad hands, duplicate character, multiple people"
)
...
def workflow(prefix,prompt,negative,seed,denoise):
    return {
      ...
      "17":{"class_type":"AnimaLLLiteApply","inputs":{"model":["10",0],"lllite_name":"anima-lllite-pose-1.safetensors","image":["15",0],"strength":1.35,"start_percent":0.0,"end_percent":1.0,"preserve_wrapper":True}},
...
jobs=[]
for i,(seed,denoise) in enumerate([(27062901,0.48),(27062902,0.52),(27062903,0.56)],1):
    prefix=f'louise_lowerleft_slight_raise_img2img_cand{i:02d}'

...
W,H=832,1216
POSE='2026-06-30/louise_both_hands_down_simple_wood_wand_handle_pose_ref.png'
POS=(
"masterpiece, best quality, score_7, safe, PosingDynamicsDaal, airy watercolor anime illustration, clean anime linework, "
"same composition as previous approved image, small full body character on the right side, character occupies only the right middle and right bottom ninth-grid cells, left side open, "
...
"both arms hanging down naturally, both hands lowered beside the body, one lowered hand holds a simple wooden wand with a visible grip handle, plain short straight brown wooden wand, simple wood-color rod, plain cylindrical handle, no decoration, no ornament, no gem, no curve, no bending, no glowing tip, the other lowered hand is empty and holds nothing, "
...
NEG=(
"branch, tree branch, twig, raw branch, crooked branch, irregular branch, curved wand, bent wand, ornate wand, decorated wand, gem wand, glowing wand, long staff, magic staff, fancy handle, animal head handle, spiral handle, metal wand, sword, spear, "
...
jobs=[]
for i,seed in enumerate([27062501,27062502,27062503],1):
    prompt=POS+f", candidate {i}, focus on simple straight wood-color wand with visible plain handle"
    prefix=f'louise_same_composition_castle_wood_wand_handle_cand{i:02d}'

...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("validate", "COMFYUI_START_TIMEOUT", "failed_before_activation", EXIT_FAILED_BEFORE_ACTIVATION),
        ("validate", "WORKER_START_TIMEOUT", "failed_before_activation", EXIT_FAILED_BEFORE_ACTIVATION),
        ("validate", "WORKER_STATUS_INVALID", "failed_before_activation", EXIT_FAILED_BEFORE_ACTIVATION),
        ("validate", "WORKER_PREFLIGHT_FAILED", "failed_before_activation", EXIT_FAILED_BEFORE_ACTIVATION),

...
def test_worker_discovery_settings_defaults() -> None:
    ...
    assert settings.nvidia_worker_discovery_enabled is True
    assert settings.nvidia_worker_discovery_cidr == "192.168.1.0/24"
    assert settings.nvidia_worker_discovery_timeout > 0
    assert settings.nvidia_worker_hostname == "DESKTOP-AV90PQ4"

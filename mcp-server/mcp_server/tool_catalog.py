...
INTENDED_TOOLS: tuple[ToolCatalogEntry, ...] = (
    ...
    ToolCatalogEntry("civitai_source_alias_backfill_gallery", "mcp_server.tools.civitai_recipes", "civitai_source_alias_backfill_gallery", "dict", ("POST /api/civitai-recipes/source-aliases/backfill-gallery",)),
